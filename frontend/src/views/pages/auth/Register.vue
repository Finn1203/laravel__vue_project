        ...
        ">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <InputText id="name" type="text" placeholder="Name" class="w-full md:w-[30rem] mb-8"
                            v-model="name" />
                        ...
                        <Password id="password1" v-model="password" placeholder="Password" :toggleMask="true"
                            class="mb-4" fluid></Password>

                        <label for="password1"
                            class="block text-surface-900 dark:text-surface-0 font-medium text-xl mb-2">Re-enter
                            password</label>
                        <Password id="password1" v-model="password" placeholder="password confirmation"
                            :toggleMask="true" class="mb-4" fluid></Password>

                        <Button label="Sign Up" class="w-full mt-4" as="router-link" to="/"></Button>
                        <div class="flex items-center justify-between mt-4">
                            <router-link to="/auth/login"
                                class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">
                                <span>Already registered? Click here</span>
                            </router-link>
                        </div>
                    </div>
                </div>
